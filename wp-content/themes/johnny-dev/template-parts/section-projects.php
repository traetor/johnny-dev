        ...
        <div class="projects-list">
            ...
            <article class="project-card project-card-featured">
                ...
                <div class="project-content">
                    ...
                    <h3>Johnny Systems</h3>

                    <p class="project-description">
                        Full-stack task management application with user
                        authentication, protected application routes and
                        task management functionality backed by a REST API
                    ...
                    <div class="project-links">
                        ...
                        <a
                            href="https://github.com/traetor/johnny-systems"
                            target="_blank"
                        ...
                        <a
                            href="https://github.com/traetor/johnny-systems-backend"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            Backend GitHub
